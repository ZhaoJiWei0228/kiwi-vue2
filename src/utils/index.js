...
function encrypt(content) {
  ...
  if (typeof content === 'object') {
    ...
    return CryptoJS.AES.encrypt(serialize(content), 'app-router').toString()
  }

  return CryptoJS.AES.encrypt(content.toString(), 'app-router').toString()
}
...
function decrypt(content) {
  ...
  try {
    ...
    return deserialize(CryptoJS.AES.decrypt(content, 'app-router').toString(CryptoJS.enc.Utf8))
  } catch (e) {

    return CryptoJS.AES.decrypt(content, 'app-router').toString(CryptoJS.enc.Utf8)
  }
